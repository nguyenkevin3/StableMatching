...
Instructions to compile: **g++ required to build**
  ...
  4) Drag and drop input files into src/ or example/, (input_512.in provided in example/)
  5) Input files must be of ".in" type
  6) Run: g++ -std=c++17 verifier.cpp -o verifier

Instructions to use matcher:
  1) Run: ./matchingengine [input file] (Ex: ./matchingengine ../example/input_512.in)
  2) An output file will be automatically generated in the same directory

Instructions to use verifier:
  1) Run: ./verifier [output file] [input file] (Ex: ./verifier ../example/input_512.out ../example/input_512.in)
